...
from templates.pro_kino_bot.keyboards import user_kb, subscription_kb, movie_share_kb
from templates.pro_kino_bot.handlers.subscription import check_subscription, send_subscription_message
...
def create_user_router(kino_db: KinoDB, admin_id: int) -> Router:
    ...
    async def cmd_start(message: Message, state: FSMContext):
        ...
        if message.from_user.id == admin_id:
            from templates.pro_kino_bot.keyboards import admin_main_kb
